...
public class DecisionMaking {
    public static void main(String[] args) {
        ...
        if (choice3 == 1) {
            ...
            System.out.println("The old lady stomps around but eventually leaves.");
        } else {
            System.out.println("Dream collapses. Game over.");
            return;
        }
        ...
        System.out.println("You rush to school and take your test.");
        System.out.println("When the scores come out...");

        
        if (choice1 == 2 || choice1 == 3) {
            System.out.println("\nYou get a big fat ZERO. L + Ratio. But you still survive.");
        } 
